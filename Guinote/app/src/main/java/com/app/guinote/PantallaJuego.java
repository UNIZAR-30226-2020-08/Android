...
public class PantallaJuego extends AppCompatActivity {
    ...
    ImageView c1,c2,c3,c4,c5,c6,reverse,triumphe,j1image,chat,
            ...
            j3imageback,j4imagefront,j4imageback,estrella1,estrella2,estrella3,estrella4,icono_musica;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        triumphewhole.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(quienWinner.equals(nameUser) || quienWinner.equals(nombreOponente2.getText().toString())){
                    JSONObject aux = new JSONObject();
                    try {
                        aux.put("jugador", nameUser);
                        aux.put("nombre", room);
