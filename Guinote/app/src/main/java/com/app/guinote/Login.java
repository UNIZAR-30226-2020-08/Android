...
public class Login extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        loggear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                if (validar(view, username, contra) == true) {
    ...
    public boolean validar(View view, TextInputLayout nombreusuario, TextInputLayout contra){
        boolean validado=true;
        String usuario=nombreusuario.getEditText().getText().toString();
        String contrasenia=contra.getEditText().getText().toString();

        if(usuario.isEmpty()){
            nombreusuario.setError("Escribe un nombre de usuario");
            validado=false;
        }
        else{
        ...
        if(contrasenia.isEmpty()){
            contra.setError("Escribe su password");
            validado=false;
        }
        else{
